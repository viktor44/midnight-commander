...
# GLib follows GNOME's odd/even convention: 2.85.x were the development
# snapshots that led to stable 2.86.0, so keep this on an even series.
GLIB_MAJOR_VERSION="${GLIB_MAJOR_VERSION:-2.88}"
GLIB_MINOR_VERSION="${GLIB_MINOR_VERSION:-3}"
